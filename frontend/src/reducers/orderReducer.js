...
export const getOrdersByIdReducer=(orderid) =>(state={} , action)=>{


  switch(action.type)
  {
      case 'GET_ORDERSBYID_REQUEST' : return{
          ...state ,
          loading : true
      }
      case 'GET_ORDERSBYID_SUCCESS' : return{
       ...state ,
       loading : false,
       orders : action.payload
   }
   case 'GET_ORDERSBYID_FAILED' : return{
       ...state ,
       loading : false,
       error : true
   }
